...
// Interface pour les props du composant UsersTable
interface UsersTableProps {
  refreshTrigger?: number;
}

export default function UsersTableFixed({ refreshTrigger = 0 }: UsersTableProps) {
      ...
      setUsers([
        {
          ...
          lastLogin: "2023-05-12T15:20:00Z"
        },
        {
          id: "u2",
  ...
  // Déclencher un rechargement lorsque refreshTrigger change
  useEffect(() => {
    if (refreshTrigger > 0) {
      fetchUsers();
    }
